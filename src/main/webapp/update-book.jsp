    ...
    <div class="container-fluid p-0">
        ...
        <div class="main row">
            ...
            <div class="col-9" id="content-view">
                ...
                <div class="container">
                    <h1 class="mt-4" id="h1">Update Books</h1>
                    <hr>
                    <div class="wrapper-form-content mt-3" id="wrapper-form-content">
                        <form class="px-3" action="Update" method="post">
                                
                                Id:<%=book.getBook_ID() %> <input type="hidden" name="id" value="<%=book.getBook_ID() %>>" />
                            
                            <div class="form-group mb-3">
                                <label for="title" class="mb-1">Book Title: </label>
                                <input type="text" size="50" name="title" id="title" class="form-control form-control-sm" value="<%=book.getTitle() %>">
                            </div>
                            
                            <div class="form-group mb-3">
                                <label for="pageCount" class="mb-1">Page Count: </label>
                                <input type="text" name="pageCount" class="form-control form-control-sm" value="<%=book.getPageCount() %>">
                            </div>
                            <div class="form-group mb-3">
                                <label for="price" class="mb-1">Price: </label>
                                <input type="number" name="price" class="form-control form-control-sm" value="<%=book.getPrice() %>" >
                            </div>
                            <div class="form-group mb-3">
                                <label for="datePublished" class="mb-1">Date published: </label>
                                <input type="date" name="datePublished" class="form-control form-control-sm" value="<%=book.getDatepublished() %>" >
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <% for(Author a: author){
                                %>
                                	<option <%=(a.getAuthor_Id()==book.getAuth().getAuthor_Id() )?"selected=\"selected\"":"" %>
                                		value="<%=a.getAuthor_Id() %>"><%=a.getAuthor_Name() %></option>
                            ...
                            <div class="btn-group mb-3">
                                <input type="submit" class="btn btn-light btn-sm border mr-2" value="Update"></input>                                
                            </div>
                        </form>
                    </div>
                </div>
